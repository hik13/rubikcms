...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,zip,rar,ppt,rtf,doc,pdf,xls,txt,php,html,htm,css');//
	define("CONFIG_VIEWABLE_VALID_EXTS", 'gif,bmp,txt,jpg,png,tif,html,htm,php,js,css,xml,xsl,dtd,mp3,wav,wmv,wma,rm,rmvb,mov,swf');
