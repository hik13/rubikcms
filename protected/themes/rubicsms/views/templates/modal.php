...
<h1>Выбор единицы измерения</h1>

<a href="#" class="extended-main-menu-close"></a>
...
<div class="column-50-percent">
	...
	<a href="#" class="add-group-parametr">Добавить</a>
	</div>
	<ul class="unit">
		<li class="editing">
			<div class="unit-item">
				<div class="unit-title">Размер</div>
				<div class="modal-actions"><a href="#" class="unit-add"></a><a href="#" class="unit-edit"></a> <a href="#" class="unit-delete"></a></div>
			</div>
			
			<div class="unit-edit-block">
				<div class="unit-edit-input"><div class="input-border"><input type="text" /></div></div>
				<div class="modal-actions"><a href="#" class="unit-ok"></a><a href="#" class="unit-cancel"></a></div>		
			</div>
		</li>
		...
		<li class="active-unit">
			<div class="unit-item">
				<div class="unit-title">Объем</div>
				<div class="modal-actions"><a href="#" class="unit-add"></a><a href="#" class="unit-edit"></a> <a href="#" class="unit-delete"></a></div>
			</div>
		...
		<li>
			<div class="unit-item">
				<div class="unit-title">Площадь</div>
				<div class="modal-actions"><a href="#" class="unit-add"></a><a href="#" class="unit-edit"></a> <a href="#" class="unit-delete"></a></div>
			</div>
...
<div class="column-50-percent">
	...
	<div class="unit-value-block" style="display:none;" >	
	
	<ul class="unit-value">
		<li>Милиметры<div class="modal-actions"><a href="#" class="unit-edit"></a> <a href="#" class="unit-delete"></a></div></li>
		<li>Сантиметры<div class="modal-actions"><a href="#" class="unit-edit"></a> <a href="#" class="unit-delete"></a></div></li>
		<li>Метры<div class="modal-actions"><a href="#" class="unit-edit"></a> <a href="#" class="unit-delete"></a></div></li>
		<li>Километры<div class="modal-actions"><a href="#" class="unit-edit"></a> <a href="#" class="unit-delete"></a></div></li>
		<li>Милиметры<div class="modal-actions"><a href="#" class="unit-edit"></a> <a href="#" class="unit-delete"></a></div></li>
		<li>Сантиметры<div class="modal-actions"><a href="#" class="unit-edit"></a> <a href="#" class="unit-delete"></a></div></li>
		<li>Метры<div class="modal-actions"><a href="#" class="unit-edit"></a> <a href="#" class="unit-delete"></a></div></li>
		<li>Километры<div class="modal-actions"><a href="#" class="unit-edit"></a> <a href="#" class="unit-delete"></a></div></li>
	...
	<li class="simple-button">
		<a href="#">
			<div class="module-action-button-left"></div>
			<div class="module-action-button-title">Сохранить</div>
			<div class="module-action-button-right"></div>
		</a>
	</li>
	<li class="simple-button red">
		<a href="#">
			<div class="module-action-button-left"></div>
			<div class="module-action-button-title">Отменить</div>
			<div class="module-action-button-right"></div>
		</a>
	</li>
</ul>
