<?php 
 return Array( 
	"basePath" => "Z:\home\qa.sait\www\protected\config\..", 
	"runtimePath" => "Z:/home/qa.sait/www/site/runtime", 
	"theme" => "rubicsms", 
        'preload' => array('log'),
	"import" =>array( 
	...
	"components" => array(
        "assetManager" => array(
            "basePath" => "Z:/home/qa.sait/www/site/assets",
            "baseUrl" => "/site/assets",
        ),
        "themeManager" => array(
            "basePath" => "Z:/home/qa.sait/www/site/themes",
            "baseUrl" => "/site/themes",
        ),
        "user" => array(
            "allowAutoLogin" => "1",
        ...
        "urlManager" => array(
            ...
            "rules" => array(
                ...
                "management/<m:>*" => "<m>",
                "content/customaction" => "content/customaction",
                "0" => array(
        ...
        "db" => array(
            "class" => "CDbConnection",
            "connectionString" => "mysql:host=localhost;dbname=portfolio_new",
            "emulatePrepare" => "1",
            "username" => "root",
            "password" => "",
            "charset" => "utf8",
